...
CLLibrary::CLLibrary() {
	...
	error = clGetDeviceIDs(platformIds[PLATFORM_NUMBER], CL_DEVICE_TYPE_GPU, 0, NULL, &deviceIdCount); 
	...
	clGetDeviceIDs(platformIds[PLATFORM_NUMBER], CL_DEVICE_TYPE_GPU, deviceIdCount, deviceIds.data(), NULL); 	
